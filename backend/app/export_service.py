...
• OpenAI GPT-5.4 - Strategic analysis, synthesis, classification, and report generation
...
AI_DISCLOSURE_SHORT = (
    ...
    "AI Technologies: OpenAI GPT-5.4, GPT Researcher, SearXNG, Serper"
)
...
class ProfessionalPDFBuilder:
    ...
    def _draw_footer(self, canvas_obj: canvas.Canvas, doc):
        ...
        if self.include_ai_disclosure:
            ...
            disclosure_lines = [
                "AI-Powered Intelligence: This report was generated using OpenAI GPT-5.4, GPT Researcher,",
...
class ExportService:
    ...
    def _add_pptx_footer(self, slide, include_ai_disclosure: bool = True) -> None:
        ...
        if include_ai_disclosure:
            ...
            disclosure_para.text = "AI Technologies: OpenAI GPT-5.4, GPT Researcher, SearXNG, Serper"
...
• OpenAI GPT-5.4 - Strategic analysis, classification, and scoring
• GPT Researcher - Autonomous deep research orchestration
• SearXNG and Serper - Web search aggregation
• trafilatura - Article extraction from source URLs
